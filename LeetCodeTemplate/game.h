...
class Game
{
   virtual Client* onJoin() = 0;
   virtual void onGetItem(Client* user, std::string_view name, int amount) = 0;
   virtual void onDropItem(Client* fromClientPtr, std::string_view name,
      int amount) = 0;
   virtual void onGiveItem(Client* fromClientPtr, Client* toClientPtr,
      std::string_view name, int amount) = 0;
   virtual void onLeave(Client* clientPtr) = 0;
